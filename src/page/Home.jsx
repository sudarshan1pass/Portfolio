            ...
            >
              ...
              <div className="flex items-center space-x-4">
                ...
                >
                  ...
                  <FaGithub size={24} className="text-blue-700  hover:text-gray-700"  />
                </motion.a>
                <motion.a
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.9 }}
                ...
                >
                  ...
                  <FaLinkedin  size={24}  className="text-blue-700  hover:text-gray-700" />
                </motion.a>
                ...
                >
                   ...
                   <Mail size={24} className="text-blue-700  hover:text-gray-700"  />
                </motion.a>
              </div>
            </motion.div>
