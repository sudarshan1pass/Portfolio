...
const Skill = () => {
  const skillCategories = [
    ...
    },
    {
      title: 'Backend',
      skills: [
        { name: 'Express', level: 80, color: 'from-purple-600 to-purple-700' },
        { name: 'MongoDB', level: 85, color: 'from-gray-600 to-gray-700' },
        { name: 'Node.js', level: 80, color: 'from-violet-500 to-violet-600' },
        { name: 'Postman', level: 85, color: 'from-red-500 to-red-600' },
      ]
    }
  ];

  return (
    <section id="skill" className="py-20 bg-gradient-to-br from-gray-50 to-blue-50">
